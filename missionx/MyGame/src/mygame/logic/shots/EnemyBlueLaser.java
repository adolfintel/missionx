...
public class EnemyBlueLaser extends SpriteColl implements ILoopable {

    float speedX, speedY;

    public EnemyBlueLaser(float x, float y, float scale, boolean isSource, float speedX, float speedY, int layer) {
        super(x, y, Texture.getTexture("images/blueLaser.png"), layer);
        setIdLayer(layer);
    ...
    public void onDestroy() {
        ...
        explosion.setRMax(0.2f);
        explosion.setRMin(0.3f);
        explosion.setGMax(0.2f);
        explosion.setGMin(0.3f);
