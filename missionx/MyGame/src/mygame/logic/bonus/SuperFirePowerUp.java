 ...
 * @author Do$$e
 */
public class SuperFirePowerUp extends SpriteColl implements ILoopable {

    float cycle;
    float scale, alpha = 1;

    public SuperFirePowerUp(float x, float y, float scale) {
        super(x, y, Texture.getTexture("images/superFireIcon.png"),5);
        scale*=1.25;
    ...
    public void onDestroy() {
        ...
        new Particle(Texture.getTexture("images/superFire.png"), null, false, getX(),getY(), 0, 0, 1000, 25, 25, 150, 850, 1, 1, 1, 1, 0.9f, 6, 0, 0, 0, 0, 0, 0.01f).setIdLayer(6);
    }
}
