 ...
 * @author Do$$e
 */
public class Enemy7 extends SpriteColl implements ILoopable {
    ...
    public Enemy7(float x, float y, int health) {
    ...
    public void init() {
        ...
        ship = Texture.getTexture("images/enemy7/enemy7.png");
        ship_hit = Texture.getTexture("images/enemy7/enemy7_hit.png");
        setImage(ship);
        setWidth((int) (getWidth() * scale));
        setHeight((int) (getHeight() * scale));
        
        b = new LaserBarrier(getX() + (getWidth() / 2 - 35) * scale, getY(), true);
    }
