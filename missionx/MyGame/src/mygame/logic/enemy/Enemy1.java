 ...
 * @author Do$$e
 */
public class Enemy1 extends SpriteColl implements ILoopable {
    ...
    public Enemy1(float x, float y, int health) {
    ...
    public void init() {
        ...
        ship = Texture.getTexture("images/enemy1/enemy1.png");
        ship_hit = Texture.getTexture("images/enemy1/enemy1_hit.png");
        setImage(ship);
        ...
        engine1.setX(getX());
        engine1.setY(getY());
        engine1.setxOffsetMax(220);
        engine1.setxOffsetMin(200);
        engine1.setyOffsetMax(35);
        engine1.setyOffsetMin(25);
        engine1.setParticle(bloom);
        engine1.setRMax(0.5f);
        engine1.setGMax(0.5f);
        engine1.setBMax(1f);
        engine1.setRMin(0.4f);
        engine1.setGMin(0.4f);
        engine1.setBMin(0.9f);
            ...
            if (getX() < centerX + 512 && getX() > centerX - 1000) {
                ...
                if (playerX + player.getWidth() <= getX()) {
                    if (canShot && playerY + player.getHeight() >= getY() + (32 * scale) && playerY <= getY() + getHeight() - (32 * scale)) {
                        SoundBox.play(2);
                        new EnemyStandardShot(getX() + (100 * scale), getY() + (37 * scale), scale * 0.5f, true, -40, 0, 5);
                        canShot = false;
