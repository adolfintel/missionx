...
import mygame.logic.shots.EnemyStandardShot;
import mygame.*;
 ...
 * @author Do$$e
 */
public class Enemy2 extends SpriteColl implements ILoopable {
    ...
    float scale = 1f;
    Emitter engine1, explosion, shockWave;
    ...
    public Enemy2(float x, float y, int health) {
    ...
    public void init() {
        ...
        ship = Texture.getTexture("images/enemy2/enemy2.png");
        ship_hit = Texture.getTexture("images/enemy2/enemy2_hit.png");
        setImage(ship);
        ...
        engine1.setX(getX());
        engine1.setY(getY());
        engine1.setxOffsetMax(100);
        engine1.setxOffsetMin(80);
        engine1.setyOffsetMax(50);
        engine1.setyOffsetMin(45);
            ...
            if (getX() < centerX + 512 && getX() > centerX - 1000) {
                ...
                if (playerX + player.getWidth() <= getX()) {
                    if (canShot && playerY + player.getHeight() >= getY() + (32 * scale) && playerY <= getY() + getHeight() - (32 * scale)) {
                        SoundBox.play(2);
                        new EnemyStandardShot(getX() + (5 * scale), getY() + (-5 * scale), scale * 0.5f, true, -40, 0, 5);
                        new EnemyStandardShot(getX() + (5 * scale), getY() + (95 * scale), scale * 0.5f, true, -40, 0, 5);
                        canShot = false;
